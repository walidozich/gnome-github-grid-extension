...
3. Log out and log back in on Wayland so GNOME Shell rescans user extensions.
4. Confirm GNOME sees the UUID with `gnome-extensions info github-grid@walidozich`.
5. Open preferences with `gnome-extensions prefs github-grid@walidozich`.
6. Enable the extension with `gnome-extensions enable github-grid@walidozich`.
